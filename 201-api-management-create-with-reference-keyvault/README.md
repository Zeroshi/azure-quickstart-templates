...
with SSL Certificate from
[KeyVault as Resource Manager Reference](https://azure.microsoft.com/en-us/documentation/articles/resource-manager-keyvault-parameter/).

In order to deploy this template, you need to have the following resources:

1. A Key Vault
2. An ssl certificate issued for the domain that you want to configure proxy
   for. This can be a self-signed certificate.
