...
This template allows you to deploy simple Windows VM and Recovery Services Vault
configured with the DefaultPolicy for Protection.
...
Tags: Azure Backup, Backup, Resource Manager, Resource Manager templates, ARM
templates
