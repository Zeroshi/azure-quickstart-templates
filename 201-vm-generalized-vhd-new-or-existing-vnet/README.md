...
- A generalized VHD file that you want to create a VM from already exists in a
  storage account.
...
This template creates a VM from a generalized VHD and lets you connect it to a
