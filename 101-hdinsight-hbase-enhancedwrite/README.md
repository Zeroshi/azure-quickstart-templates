# Deploy an HDInsight Linux-based HBase cluster with enhanced writes
...
This template allows you to create a Linux-based HBase cluster with enhanced
writes in HDInsight. For more information; see
